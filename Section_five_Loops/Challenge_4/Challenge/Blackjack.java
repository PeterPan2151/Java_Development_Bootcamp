...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        int sum = Math.min(userCard1, 10) + Math.min(userCard2, 10);
        ...
        while (sumDealer < 17) {
            ...
            sumDealer += Math.min(dealerCard, 10);
    ...
    public static String hitOrStay() {
        ...
        boolean invalidResponse = !(option.equalsIgnoreCase("hit") || option.equalsIgnoreCase("stay"));
